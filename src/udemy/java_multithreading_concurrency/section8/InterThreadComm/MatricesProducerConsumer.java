package udemy.java_multithreading_concurrency.section8.InterThreadComm;
 ...
 *
 * Here we use a thread safe queue to decouple the producer/consumer and using the await()/notify() to keep the Q size
